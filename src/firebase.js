...
const serviceAccount = {
  ...
  private_key_id: process.env.SA_PRIVATE_KEY_ID ?? process.env.FIREBASE_PRIVATE_KEY_ID,
  private_key: (process.env.SA_PRIVATE_KEY ?? process.env.FIREBASE_PRIVATE_KEY)?.replace(/\\n/g, '\n'),
  client_email: process.env.SA_CLIENT_EMAIL ?? process.env.FIREBASE_CLIENT_EMAIL,
  client_id: process.env.SA_CLIENT_ID ?? process.env.FIREBASE_CLIENT_ID,
